...
Obj* Obj::getCollisionPoint(double x, double y, ObjectType obj)
{
    if(obj == NULL)
    {
...
Obj* Obj::getCollisionLine(double x1, double y1, double x2, double y2, ObjectType obj, int steps)
{
    double cx, cy;
    cx = x1;
    cy = y1;
    ...
    for(int i = 0; i<steps; i++)
    {
        ...
        Obj* o = getCollisionPoint(cx, cy, obj);
        if(o != NULL)
        {
            return NULL;
        }
