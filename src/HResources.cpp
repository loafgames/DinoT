...
//sprites
sf::Image HResources::sprTileWater;
sf::Image HResources::sprDino;
//bkg
...
HResources::HResources(void)
{
	...
	sprTileWater.LoadFromFile("assets/gfx/sprTileWater.png");
	sprDino.LoadFromFile("assets/gfx/sprDino.png");
